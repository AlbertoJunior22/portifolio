...
(1, 'system', 'system', now(), now(), 'CREATE_PERSON', false),
(2, 'system', 'system', now(), now(), 'UPDATE_PERSON', false),
(3, 'system', 'system', now(), now(), 'DELETE_PERSON', false),
(4, 'system', 'system', now(), now(), 'RETRIEVE_ALL_PERSON', false),
(5, 'system', 'system', now(), now(), 'RETRIEVE_PERSON', false);

insert into profile(
    id, altered_by, created_by, created_date, updated_date, profile
) values
(1, 'system', 'system', now(), now(), 'ADMIN');
...
(1, 'system', 'system', now(), now(), now(), 'admin@email.com', '000.000.000-00',
